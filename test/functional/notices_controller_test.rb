...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { content: @notice.content, filenumber: @notice.filenumber, title: @notice.title }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { content: @notice.content, filenumber: @notice.filenumber, title: @notice.title }
    assert_redirected_to notice_path(assigns(:notice))
  end
